...
def process_and_predict(image_path, input_size, predicted_label, predicted_box):
    # Load the image
    ...
    output_image_path = 'Example/predicted.jpeg'
...
process_and_predict(image_path, input_size, predicted_label, predicted_box)
